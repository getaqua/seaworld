                ...
                child: Builder(
                  builder: (context) {
                    ...
                    return Container(
                      width: 480,
                      margin: EdgeInsets.symmetric(horizontal: 8.0),
                      child: (flow is! FlowWithContent && result.isLoading) ? Center(child: CircularProgressIndicator(value: null))
                        : (flow is! FlowWithContent) ? ListView.builder(
                          itemBuilder: (context, index) => _prefixes,
